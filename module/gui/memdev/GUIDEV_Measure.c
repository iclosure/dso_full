...
#ifndef PIXELINDEX
  #define PIXELINDEX        U16 // [UNIC 用户已修改]
  #define BITSPERPIXEL      16 // [UNIC 用户已修改]
  #define API_LIST          _APIList // [UNIC 用户已修改]
#endif
...
static const tLCDDEV_APIList _APIList = {
  ...
  _FillPolygonAA,
  NULL, // [UNIC 用户添加]
  BITSPERPIXEL        /* BitsPerPixel */ // [UNIC 用户添加]  
};
