...
dd_newSoundMixer()
{
	ddSoundMixer* mixer = (ddSoundMixer *)(dd_malloc(sizeof(ddSoundMixer)));
...
{
	struct streamingSound* stream = (struct streamingSound *)(dd_malloc(sizeof(struct streamingSound)));
...
ddSoundMixer_playSoundInstance(ddSoundMixer* mixer, ddDrawClip* clip, ddSoundInstance* sound)
{
	...
	item = (ddPlayingSound *)(dd_malloc(sizeof(ddPlayingSound)));
