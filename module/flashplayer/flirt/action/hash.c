...
{
	int i;
	ddActionHash* hash = (ddActionHash *)(dd_malloc(sizeof(ddActionHash)));
	hash->buckets = (ddActionHashBucket **)(dd_malloc(size * sizeof(ddActionHashBucket)));
...
ddActionHash_addValue_flags(ddActionHash* hash, char* name, ddActionValue value, int flags)
{
	...
	ddActionHashBucket* bucket = (ddActionHashBucket *)(dd_malloc(sizeof(ddActionHashBucket)));
...
ddActionHash_rehash(ddActionHash* hash, int size)
{
	...
	ddActionHashBucket* bucket;
	ddActionHashBucket* next;
	ddActionHashBucket** newBuckets = (ddActionHashBucket **)(dd_malloc(size * sizeof(ddActionHashBucket*)));
