...
{
	ddActionFunction* function = (ddActionFunction *)(dd_malloc(sizeof(struct _ddActionFunction)));
...
ddActionFunction_call(ddActionFunction* function, ddActionObject* object,
					  ddActionContext** contextPtr, ddActionObject* class_p,
