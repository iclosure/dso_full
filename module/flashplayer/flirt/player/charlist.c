...
dd_newCharacterList()
{
	ddCharacterList* charList = (ddCharacterList *)(dd_malloc(sizeof(struct _ddCharacterList)));
...
ddCharacterList_addCharacter(ddCharacterList* charList, int id, ddCharacter* c)
{
	...
	{
		charList->chars = (ddCharacter **)(dd_realloc(charList->chars, (id + 1) * sizeof(ddCharacter)));
