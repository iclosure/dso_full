...
{
	ddFont* f = (ddFont *)(dd_malloc(sizeof(ddFont)));
	int i;
	...
	f->glyphs = (ddShape **)(dd_malloc(glyphCount * sizeof(ddShape*)));
	f->advances = (fixed *)(dd_malloc(glyphCount * sizeof(fixed)));
	...
	f->mapCount = 256;
	f->charmap = (int *)(dd_malloc(256 * sizeof(int)));
...
ddFont_addGlyph(ddFont* font, ddShape* shape, int id)
{
	...
	{
		font->nGlyphs = id + 1;
		font->glyphs = (ddShape **)(dd_realloc(font->glyphs, font->nGlyphs * sizeof(ddShape*)));
	}
