...
static void
ddDrawText_drawInImage(ddDrawable* d, ddImage* image, ddUpdateList* list_p,
					...
					ddColor color, int height, int x, int y)
{
	...
	d->records = (struct _ddDrawTextRecord *)(dd_realloc(d->records,
...
{
	ddDrawText* d = (ddDrawText *)(dd_malloc(sizeof(ddDrawText)));
