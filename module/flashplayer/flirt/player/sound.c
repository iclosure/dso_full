...
{
	ddSound* sound = (ddSound *)(dd_malloc(sizeof(ddSound)));
...
{
	ddSoundStreamBlock* block = (ddSoundStreamBlock *)(dd_malloc(sizeof(ddSoundStreamBlock)));
...
{
	ddSoundInstance * sound = (ddSoundInstance *)(dd_malloc(sizeof(ddSoundInstance)));
...
ddSoundInstance_addEnvelopePoint(ddSoundInstance* sound, int position, float left, float right)
{
	...
	sound->points = (struct ddSoundEnvelopePoint *)(dd_realloc(sound->points, sound->envelopeCount * sizeof(struct ddSoundEnvelopePoint)));
