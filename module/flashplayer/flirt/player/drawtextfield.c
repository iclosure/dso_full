...
rebuildShapeList(ddDrawTextField* field)
{
	...
	if ( len > 0 )
	{
		field->glyphs = (ddShapeInstance **)(dd_realloc(field->glyphs, len * sizeof(ddShape*)));
		field->advances = (fixed *)(dd_realloc(field->advances, len * sizeof(fixed)));
	}
...
void
ddDrawTextField_drawInImage(ddDrawable* d, ddImage* image, ddUpdateList* list_p,
...
{
	ddDrawTextField* drawfield = (ddDrawTextField *)(dd_malloc(sizeof(ddDrawTextField)));
